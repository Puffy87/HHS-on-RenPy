...
label event_loc_class1_0_6:
    ...
    'Как мило! Вечно голодающий [st1.fname] кормится с рук. Мда, не ожидали вы что [st2.fname] легко падет перед его хулиганскими чарами.'
    if player.getCorr() > 50:
...
label event_loc_class1_60_1:
    ...
    menu:
        'Продолжать смотреть':
            ...
            '[st1.fname] тем временем заглотнула его член на столько насколько могла ,а вторая стала посасывать его яички, [st3.fname] взял её за волосы и руками начал насаживать ее на свой член, стараясь проникнуть как можно глубже в горло.'
...
label event_loc_class1_15_3:
    ...
    menu:
        ...
        'Не обращать внимания':
            'Вы решили не испытывать судьбу, и оставили стонающего в одиночестве. Будем надеяться, что у него или неё не инфаркт, и стонет она от удовольствия а не от боли.'
            $ st1.incLust(20)
            $ st1.incCorr(1)
    $ move(curloc)
...
label event_loc_class1_15_7:
    ...
    'Вслед за движениями бёдер оставалась влажная полоса её выделений, покрывшая уже половину длины стола. По классу разносятся тихие стоны, и влажное хлюпанье юной киски. Вы привлекаете внимание лёгким потопыванием ноги.'
...
label event_loc_class1_25_8:
    ...
    show expression 'pic/locations/school/class1/lo8.jpg':
        ...
        ease  10.0 yalign 0.0
        repeat
    'Вы с некоторым умилением наблюдаете на страстным поцелуем девочек. Судя по стекающим каплям пота, они чрезвычайно возбуждены, так, что даже не заметили вашего прихода.'
    'Понаблюдав пару минут за их ласками, вы негромко окликаете их, и "предлагаете" остаться после занятий для улучшения поведения.'
...
label event_loc_class1_20_10:
    ...
    'Пальчики нежно ласкали соски и играли с капюшоном клитора, то оголяя его и то пряча назад.'
...
label event_loc_class1_50_1:
    ...
    menu:
        ...
        'Подсмотреть, что и откуда там выскальзывает':
            ...
            st1.say 'Ну хоть ты у меня и не первый, но слава богу и не сотый, так что наслаждайся, помощник!'
            ...
            menu:
                ...
                'Путь гуляют':
                    ...
                    'Ещё через пару минут пререканий дети наконец сваливают. Оставив вам на память прекрасные картинки и мокрые трусики.'
                    $ hadSex(st1,st2)
    $ move(curloc)
...
label event_loc_class1_50_3:
    ...
    st1.say 'Я, я не уверена... Кажется я слышала шаги, но мы вроде как спрятались. - задумчиво ответила [st1.fname]. Надо что-то решать. Если их действительно видели, ваша репутация может пострадать!'
    menu:
        'Пусть себе. Авось хуже не будет':
...
label event_loc_class1_50_8:
    ...
    'Член ученика на ваших глазах таранил узенькое лоно школьницы, отчего в классе были слышны влажные звуки. [st1.fname] тихо постанывала, скорее отдаваясь парню, нежели помогая ему.'
...
label event_loc_class1_70_5:
    ...
    'Да, таким девчонкам парни без надобности...'
...
label event_loc_class1Learn_15_4:
    ...
    'Скрывшись за учебником от преподавателя, но не от вас, [st1.fname] жадно исследует глубины своей пещерки так, словно в ней где то потерялось обручальное кольцо. На удивление мастурбирует ученица довольно тихо, и никто, кроме вас, ничего не замечает.'
